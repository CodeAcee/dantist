...
// ── Helpers ───────────────────────────────────────────────────────
// Ring decorations — static positions (no scroll parallax)
function ringStyle(
  _scrollY: number,
  _sceneIndex: number,
  _speed: number,
...
function SceneServices({
  ...
  return (
    ...
    >
      <div>
        <div
          style={ringStyle(scrollY, 1, -0.05, "-10%", "20%", 160, "#00e5ff")}
        />
        <div
          style={{
        ...
        {SERVICES_LIST.map((s, i) => (
          <SpotlightCard
            ...
            style={{
              ...
              borderColor:
                selectedIdx === i ? s.color : "rgba(255,255,255,0.07)",
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  fontSize: 9,
                  color: selectedIdx === i ? s.color : "rgba(255,255,255,0.2)",
      ...
      {selected && detail && (
        ...
        >
          ...
          >
            ...
            <div
              style={{
                borderTop: `1px solid ${selected.color}25`,
                paddingTop: 16,
                display: "flex",
                flexDirection: "column",
                gap: 10,
            ...
            >
              {detail.items.map((item, i) => (
                ...
                >
                  <span style={{ color: "rgba(255,255,255,0.75)", ...grotesk }}>
                    {item.name}
                  </span>
                  <span
                    style={{
                      flex: 1,
                      borderBottom: `1px dotted ${selected.color}30`,
                      marginBottom: 3,
                    }}
                  />
                  <span
        ...
        >
          <div
            style={{
              width: "100%",
              height: "100%",
              background: `linear-gradient(135deg,${c.accent}14,#1a0f20)`,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            }}
...
function SceneBeforeAfter({
  ...
  return (
    ...
    >
      <div>
        <div
          style={ringStyle(scrollY, 2, 0.06, "-5%", "60%", 200, "#ff3d8b")}
        />
        <div
          style={{
  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", position: "relative" }}>
        <div
          style={ringStyle(scrollY, 3, -0.07, "70%", "5%", 300, "#a855f7")}
        />
        <div
          style={{
            fontSize: 9,
      ...
      >
        {TEAM_LIST.filter((_, i) => !isMobile || i === 0).map((m, i) => (
          <div
            key={i}
            style={{
              padding: isMobile ? "16px 16px" : "24px 22px",
          ...
          >
            ...
            <div
              style={{
                ...
                background: `linear-gradient(135deg,${m.accent}18,#100c18)`,
                borderRadius: 3,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
        ...
        >
          ...
          >
            <div>
              ...
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="#ff3d8b">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.8a8.18 8.18 0 004.78 1.52V6.88a4.85 4.85 0 01-1.01-.19z" />
                </svg>
                <span
                  style={{
                ...
                (v, i) => (
                  <div
                    ...
                    style={{
                      ...
                      gap: 8,
                      flex: "1 1 0",
                      maxWidth: isMobile ? 240 : 210,
                      marginTop: !isMobile && i === 1 ? 28 : 0,
                    }}
                  >
                    <div
                      style={{
                        ...
                        width: "100%",
                        aspectRatio: "9/16",
                        maxHeight: isMobile ? 220 : "unset",
                        borderRadius: 8,
                        overflow: "hidden",
                        background: "#111",
                        border: `1px solid ${i === 0 ? "rgba(255,61,139,0.3)" : "rgba(0,229,255,0.2)"}`,
                        boxShadow:
                          i === 0
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: 8,
                      overflow: "hidden",
                      border: `1px solid rgba(225,48,108,${i === 0 ? "0.3" : "0.2"})`,
                      boxShadow:
                        i === 0
          ...
          <div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                ...
                <span
                  style={{ color: "#c8ff00", fontSize: 10, letterSpacing: 1 }}
                >
                  ★★★★★
                </span>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  style={{
                    ...
                    appearance: "none",
                    cursor: "pointer",
                    color: form.service ? "#f0f0f0" : "rgba(255,255,255,0.3)",
                  }}
                >
...
export default function ZoomerMode() {
  ...
  const scrollY = 0; // kept for scene component prop compatibility; rings are static
  ...
  // Wheel snap — fires on first event, then blocks until 300ms after last inertia event
  useEffect(() => {
              ...
              {SCENES.map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      i === sceneIdx ? s.accent : "rgba(255,255,255,0.18)",
                    border: "none",
                    cursor: "pointer",
                    padding: 0,
                    transition: "all 0.3s",
                    boxShadow:
                      i === sceneIdx
                        ? `0 0 10px ${s.accent}, 0 0 20px ${s.accent}60`
                        : "none",
                  }}
                  aria-label={s.label}
                />
                ...
                {SCENES.map((s, i) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 3,
                      background:
                        i === sceneIdx ? s.accent : "rgba(255,255,255,0.2)",
                      border: "none",
                      cursor: "pointer",
                      padding: 0,
                      transition: "all 0.3s",
