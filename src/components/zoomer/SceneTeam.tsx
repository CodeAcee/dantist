          ...
          .map((m, i) => (
            ...
            >
              ...
              <div className={styles.social}>
                <a href={m.ig} target="_blank" rel="noopener noreferrer" className={`${styles.linkBase} ${styles.ig}`}>
                ...
                <a href={m.tiktok} target="_blank" rel="noopener noreferrer" className={`${styles.linkBase} ${styles.tiktok}`}>
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor">
