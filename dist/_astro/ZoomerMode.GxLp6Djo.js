import { j as a } from "./jsx-runtime.TBa3i5EZ.js";
import { r as z } from "./index.CVf8TyFT.js";
import { s as Y } from "./supabase.CCPuGjJh.js";
/* empty css                       */ import {
  i as Ee,
  e as ye,
  d as _e,
  ...
  M as Te,
  m as V,
} from "./use-motion-value.DSiYqYDr.js";
function Ae(...t) {
...
function Se(t, e) {
  ...
  return (
    s(),
    _e(() => {
      const r = () => ve.preRender(s, !1, !0),
        n = t.map((l) => l.on("change", r));
      return () => {
        (n.forEach((l) => l()), be(s));
      };
    }),
...
function Fe(t) {
  (($.current = []), t());
  const e = Se($.current, t);
  return (($.current = void 0), e);
}
function ke(t, e, i, s) {
  if (typeof t == "function") return Fe(t);
  const n = typeof e == "function" ? e : Ae(e, i, s),
    l = Array.isArray(t) ? Z(t, n) : Z([t], ([c]) => n(c)),
  ...
  return (
    o &&
      ...
      Array.isArray(i) &&
      s?.clamp !== !1 &&
      (l.accelerate = { ...o, times: e, keyframes: i, isTransformed: !0 }),
    l
  );
}
function Z(t, e) {
  ...
  return Se(t, () => {
    i.length = 0;
    const s = t.length;
    for (let r = 0; r < s; r++) i[r] = t[r].get();
    return e(i);
  });
}
function Ie(t) {
  const e = z.useRef(0),
    { isStatic: i } = z.useContext(Te);
  z.useEffect(() => {
    if (i) return;
    const s = ({ timestamp: r, delta: n }) => {
      (e.current || (e.current = r), t(r - e.current, n));
    };
    return (ve.update(s, !0), () => be(s));
  }, [t]);
}
function D(t) {
  let e = t[0],
...
function Pe(t, e, i) {
  let s = e[0],
    r = e[1],
    n = e[2],
    l = i[3] * s + i[7] * r + i[11] * n + i[15];
  return (
    (l = l || 1),
    (t[0] = (i[0] * s + i[4] * r + i[8] * n + i[12]) / l),
    (t[1] = (i[1] * s + i[5] * r + i[9] * n + i[13]) / l),
    (t[2] = (i[2] * s + i[6] * r + i[10] * n + i[14]) / l),
    t
  );
}
function Ge(t, e, i) {
  ...
  return (
    (l = l || 1),
    (t[0] = (i[0] * s + i[4] * r + i[8] * n) / l),
    (t[1] = (i[1] * s + i[5] * r + i[9] * n) / l),
    (t[2] = (i[2] * s + i[6] * r + i[10] * n) / l),
    t
  );
}
function qe(t, e, i) {
...
class R extends Array {
  ...
  set(e, i = e, s = e) {
    return e.length ? this.copy(e) : (Re(this, e, i, s), this);
  }
  copy(e) {
    return (X(this, e), this);
  }
  add(e, i) {
    return (i ? Q(this, e, i) : Q(this, this, e), this);
  }
  sub(e, i) {
    return (i ? K(this, e, i) : K(this, this, e), this);
  }
  multiply(e) {
    return (e.length ? Le(this, this, e) : P(this, this, e), this);
  }
  divide(e) {
    return (e.length ? Be(this, this, e) : P(this, this, 1 / e), this);
  }
  inverse(e = this) {
  ...
  distance(e) {
    return e ? Oe(this, e) : D(this);
  }
  squaredLen() {
    return J(this);
  }
  squaredDistance(e) {
    return e ? Ne(this, e) : J(this);
  }
  negate(e = this) {
    return (De(this, e), this);
  }
  cross(e, i) {
    return (i ? ee(this, e, i) : ee(this, this, e), this);
  }
  scale(e) {
    return (P(this, this, e), this);
  }
  normalize() {
  ...
  applyMatrix3(e) {
    return (qe(this, this, e), this);
  }
  applyMatrix4(e) {
    return (Pe(this, this, e), this);
  }
  scaleRotateMatrix4(e) {
    return (Ge(this, this, e), this);
  }
  applyQuaternion(e) {
    return (Ue(this, this, e), this);
  }
  angle(e) {
    return Xe(this, e);
  }
  lerp(e, i) {
    return ($e(this, this, e, i), this);
  }
  smoothLerp(e, i, s) {
    return (Ve(this, this, e, i, s), this);
  }
  clone() {
    return new R(this[0], this[1], this[2]);
  }
  fromArray(e, i = 0) {
    return ((this[0] = e[i]), (this[1] = e[i + 1]), (this[2] = e[i + 2]), this);
  }
  toArray(e = [], i = 0) {
    return ((e[i] = this[0]), (e[i + 1] = this[1]), (e[i + 2] = this[2]), e);
  }
...
class Qe {
  constructor(e, i = {}) {
    ...
    for (let s in i) this.addAttribute(s, i[s]);
  }
  addAttribute(e, i) {
    if (
      ((this.attributes[e] = i),
      ...
      (i.type =
        i.type ||
        (i.data.constructor === Float32Array
          ? this.gl.FLOAT
          : i.data.constructor === Uint16Array
      ...
      (i.count =
        i.count ||
        (i.stride ? i.data.byteLength / i.stride : i.data.length / i.size)),
      ...
      e === "index"
        ? (this.drawRange.count = i.count)
        : this.attributes.index ||
          (this.drawRange.count = Math.max(this.drawRange.count, i.count));
  }
  updateAttribute(e) {
    const i = !e.buffer;
  ...
  bindAttributes(e) {
    (e.attributeLocations.forEach((i, { name: s, type: r }) => {
      ...
      let l = 1;
      (r === 35674 && (l = 2), r === 35675 && (l = 3), r === 35676 && (l = 4));
      const o = n.size / l,
        c = l === 1 ? 0 : l * l * 4,
        h = l === 1 ? 0 : l * 4;
      for (let d = 0; d < l; d++)
        (this.gl.vertexAttribPointer(
          ...
          this.gl.enableVertexAttribArray(i + d),
          this.gl.renderer.vertexAttribDivisor(i + d, n.divisor));
    }),
      this.attributes.index &&
        this.gl.bindBuffer(
  ...
  draw({ program: e, mode: i = this.gl.TRIANGLES }) {
    (this.gl.renderer.currentGeometry !== `${this.id}_${e.attributeOrder}` &&
      ...
      this.gl.renderer.bindVertexArray(this.VAOs[e.attributeOrder]),
      (this.gl.renderer.currentGeometry = `${this.id}_${e.attributeOrder}`)),
      e.attributeLocations.forEach((r, { name: n }) => {
        const l = this.attributes[n];
        l.needsUpdate && this.updateAttribute(l);
      }));
    let s = 2;
  ...
  computeBoundingBox(e) {
    ...
    const r = this.bounds.min,
      ...
      o = this.bounds.scale;
    (r.set(1 / 0), n.set(-1 / 0));
    for (let c = 0, h = i.length; c < h; c += s) {
      const d = i[c],
        f = i[c + 1],
        p = i[c + 2];
      ((r.x = Math.min(d, r.x)),
  ...
  computeBoundingSphere(e) {
    ...
    let r = 0;
    for (let n = 0, l = i.length; n < l; n += s)
      (te.fromArray(i, n),
        (r = Math.max(r, this.bounds.center.squaredDistance(te))));
...
class Je {
  constructor(
    ...
    (e.canvas || console.error("gl not passed as first argument to Program"),
      ...
      this.setShaders({ vertex: i, fragment: s }));
  }
  setShaders({ vertex: e, fragment: i }) {
    if (
      (e &&
...
${re(i)}`)),
    ...
    for (let l = 0; l < s; l++) {
      let o = this.gl.getActiveUniform(this.program, l);
      this.uniformLocations.set(
        o,
        this.gl.getUniformLocation(this.program, o.name),
      );
      const c = o.name.match(/(\w+)/g);
      ((o.uniformName = c[0]), (o.nameComponents = c.slice(1)));
    }
    this.attributeLocations = new Map();
    const r = [],
      n = this.gl.getProgramParameter(this.program, this.gl.ACTIVE_ATTRIBUTES);
    for (let l = 0; l < n; l++) {
      const o = this.gl.getActiveAttrib(this.program, l),
        c = this.gl.getAttribLocation(this.program, o.name);
      c !== -1 && ((r[c] = o.name), this.attributeLocations.set(o, c));
    }
  ...
  setBlendEquation(e, i) {
    ((this.blendEquation.modeRGB = e), (this.blendEquation.modeAlpha = i));
  }
  setStencilFunc(e, i, s) {
    ((this.stencilRef = i),
  ...
  use({ flipFaces: e = !1 } = {}) {
    ...
    (this.gl.renderer.state.currentProgram === this.id ||
      ...
      this.uniformLocations.forEach((r, n) => {
        let l = this.uniforms[n.uniformName];
        ...
        if (!l) return ne(`Active uniform ${n.name} has not been supplied`);
        if (l && l.value === void 0)
          return ne(`${n.name} uniform is missing a value parameter`);
        if (l.value.texture)
          return ((i = i + 1), l.value.update(i), G(this.gl, n.type, r, i));
        if (l.value.length && l.value[0].texture) {
          const o = [];
          return (
            l.value.forEach((c) => {
              ((i = i + 1), c.update(i), o.push(i));
            }),
            G(this.gl, n.type, r, o)
          );
        }
        G(this.gl, n.type, r, l.value);
      }),
      this.applyState(),
      e &&
...
function ne(t) {
  q > 100 ||
    (console.warn(t),
    q++,
    q > 100 && console.warn("More than 100 program warnings - stopping logs."));
}
const U = new R();
let st = 1;
class rt {
  constructor({
    ...
    ((this.dpr = r),
      ...
      (this.autoClear = p),
      (this.id = st++),
      g === 2 && (this.gl = e.getContext("webgl2", x)),
      (this.isWebgl2 = !!this.gl),
      this.gl || (this.gl = e.getContext("webgl", x)),
  ...
  setViewport(e, i, s = 0, r = 0) {
    (this.state.viewport.width === e && this.state.viewport.height === i) ||
  ...
  setBlendFunc(e, i, s, r) {
    (this.state.blendFunc.src === e &&
      ...
      (this.state.blendFunc.dstAlpha = r),
      s !== void 0
        ? this.gl.blendFuncSeparate(e, i, s, r)
        : this.gl.blendFunc(e, i));
  }
  setBlendEquation(e, i) {
    ((e = e || this.gl.FUNC_ADD),
      !(
        ...
        (this.state.blendEquation.modeAlpha = i),
        i !== void 0
          ? this.gl.blendEquationSeparate(e, i)
  ...
  setStencilFunc(e, i, s) {
    (this.state.stencilFunc === e &&
      ...
      this.gl.stencilFunc(e || this.gl.ALWAYS, i || 0, s || 0));
  }
  setStencilOp(e, i, s) {
  ...
  bindFramebuffer({ target: e = this.gl.FRAMEBUFFER, buffer: i = null } = {}) {
    this.state.framebuffer !== i &&
      ((this.state.framebuffer = i), this.gl.bindFramebuffer(e, i));
  }
  getExtension(e, i, s) {
    return i && this.gl[i]
      ? this.gl[i].bind(this.gl)
  ...
  sortOpaque(e, i) {
    return e.renderOrder !== i.renderOrder
      ? e.renderOrder - i.renderOrder
      : e.program.id !== i.program.id
        ? e.program.id - i.program.id
        : e.zDepth !== i.zDepth
          ? e.zDepth - i.zDepth
          : i.id - e.id;
  ...
  getRenderList({ scene: e, camera: i, frustumCull: s, sort: r }) {
    ...
    if (
      ...
      e.traverse((l) => {
        ...
        l.draw &&
          ((s && l.frustumCulled && i && !i.frustumIntersectsMesh(l)) ||
            n.push(l));
      }),
      r)
    ) {
      ...
      (n.forEach((h) => {
        (h.program.transparent
          ...
          : l.push(h),
          (h.zDepth = 0),
          !(h.renderOrder !== 0 || !h.program.depthTest || !i) &&
            (h.worldMatrix.getTranslation(U),
            U.applyMatrix4(i.projectionViewMatrix),
            (h.zDepth = U.z)));
      }),
        l.sort(this.sortOpaque),
...
function xt(t, e) {
  let i = e[0],
    ...
    l = i * i + s * s + r * r + n * n,
    o = l ? 1 / l : 0;
  return ((t[0] = -i * o), (t[1] = -s * o), (t[2] = -r * o), (t[3] = n * o), t);
}
function ut(t, e) {
  return ((t[0] = -e[0]), (t[1] = -e[1]), (t[2] = -e[2]), (t[3] = e[3]), t);
}
function mt(t, e) {
  ...
  if (i > 0)
    ...
    let n = (r + 1) % 3,
      l = (r + 2) % 3;
    ((s = Math.sqrt(e[r * 3 + r] - e[n * 3 + n] - e[l * 3 + l] + 1)),
      (t[r] = 0.5 * s),
      (s = 0.5 / s),
      (t[3] = (e[n * 3 + l] - e[l * 3 + n]) * s),
      (t[n] = (e[n * 3 + r] + e[r * 3 + n]) * s),
      (t[l] = (e[l * 3 + r] + e[r * 3 + l]) * s));
  }
  return t;
}
function yt(t, e, i = "YXZ") {
...
class wt extends Array {
  constructor(e = 0, i = 0, s = 0, r = 1) {
    (super(e, i, s, r), (this.onChange = () => {}), (this._target = this));
    const n = ["0", "1", "2", "3"];
    return new Proxy(this, {
      set(l, o) {
        const c = Reflect.set(...arguments);
        return (c && n.includes(o) && l.onChange(), c);
      },
    });
  }
  get x() {
  ...
  identity() {
    return (ct(this._target), this.onChange(), this);
  }
  set(e, i, s, r) {
    return e.length
      ? this.copy(e)
      : (vt(this._target, e, i, s, r), this.onChange(), this);
  }
  rotateX(e) {
    return (dt(this._target, this._target, e), this.onChange(), this);
  }
  rotateY(e) {
    return (ft(this._target, this._target, e), this.onChange(), this);
  }
  rotateZ(e) {
    return (pt(this._target, this._target, e), this.onChange(), this);
  }
  inverse(e = this._target) {
    return (xt(this._target, e), this.onChange(), this);
  }
  conjugate(e = this._target) {
    return (ut(this._target, e), this.onChange(), this);
  }
  copy(e) {
    return (bt(this._target, e), this.onChange(), this);
  }
  normalize(e = this._target) {
    return (jt(this._target, e), this.onChange(), this);
  }
  multiply(e, i) {
    return (
      i ? le(this._target, e, i) : le(this._target, this._target, e),
      this.onChange(),
      this
    );
  }
  dot(e) {
    return St(this._target, e);
  }
  fromMatrix3(e) {
    return (mt(this._target, e), this.onChange(), this);
  }
  fromEuler(e, i) {
    return (yt(this._target, e, e.order), i || this.onChange(), this);
  }
  fromAxisAngle(e, i) {
    return (ht(this._target, e, i), this.onChange(), this);
  }
  slerp(e, i) {
    return (gt(this._target, this._target, e, i), this.onChange(), this);
  }
  fromArray(e, i = 0) {
    return (
      (this._target[0] = e[i]),
      (this._target[1] = e[i + 1]),
      (this._target[2] = e[i + 2]),
      (this._target[3] = e[i + 3]),
      this.onChange(),
      this
    );
  }
...
function Et(t, e, i, s, r, n, l, o, c, h, d, f, p, g, x, m, u) {
  return (
    (t[0] = e),
    (t[1] = i),
    (t[2] = s),
...
function we(t) {
  let e = t[0],
    ...
    k = d * u - p * x,
    T = f * u - p * m;
  return b * T - C * k + S * M + y * F - v * A + j * E;
}
function ae(t, e, i) {
  let s = e[0],
    r = e[1],
  ...
  return (
    ...
    (t[8] = S * s + y * o + v * f + j * m),
    (t[9] = S * r + y * c + v * p + j * u),
    (t[10] = S * n + y * h + v * g + j * b),
    (t[11] = S * l + y * d + v * x + j * C),
    (S = i[12]),
    (y = i[13]),
    (v = i[14]),
    (j = i[15]),
    (t[12] = S * s + y * o + v * f + j * m),
    (t[13] = S * r + y * c + v * p + j * u),
    (t[14] = S * n + y * h + v * g + j * b),
    (t[15] = S * l + y * d + v * x + j * C),
    t
  );
}
function Tt(t, e, i) {
  ...
  return (
    e === t
      ? ((t[12] = e[0] * s + e[4] * r + e[8] * n + e[12]),
        (t[13] = e[1] * s + e[5] * r + e[9] * n + e[13]),
        (t[14] = e[2] * s + e[6] * r + e[10] * n + e[14]),
        (t[15] = e[3] * s + e[7] * r + e[11] * n + e[15]))
      : ((l = e[0]),
        (o = e[1]),
        (c = e[2]),
        (h = e[3]),
        ...
        (t[10] = u),
        (t[11] = b),
        (t[12] = l * s + d * r + x * n + e[12]),
        (t[13] = o * s + f * r + m * n + e[13]),
        (t[14] = c * s + p * r + u * n + e[14]),
        (t[15] = h * s + g * r + b * n + e[15])),
    t
  );
}
function At(t, e, i) {
...
function ze(t, e) {
  ...
  return (
    ...
    (t[1] = Math.hypot(n, l, o)),
    (t[2] = Math.hypot(c, h, d)),
    t
  );
}
function It(t) {
  ...
  const d = e * e + i * i + s * s,
    f = r * r + n * n + l * l,
    p = o * o + c * c + h * h;
  return Math.sqrt(Math.max(d, f, p));
}
const Ce = (function () {
  const t = [1, 1, 1];
  return function (e, i) {
    ...
    return (
      u > 0
        ? ((b = Math.sqrt(u + 1) * 2),
          ...
          (e[2] = (c - d) / b))
        : o > f && o > m
          ? ((b = Math.sqrt(1 + o - f - m) * 2),
            (e[3] = (p - x) / b),
            (e[0] = 0.25 * b),
            (e[1] = (c + d) / b),
            (e[2] = (g + h) / b))
          : f > m
            ? ((b = Math.sqrt(1 + f - o - m) * 2),
              (e[3] = (g - h) / b),
              (e[0] = (c + d) / b),
              (e[1] = 0.25 * b),
              (e[2] = (p + x) / b))
            : ((b = Math.sqrt(1 + m - o - f) * 2),
              (e[3] = (c - d) / b),
              (e[0] = (g + h) / b),
              (e[1] = (p + x) / b),
              (e[2] = 0.25 * b)),
...
function Rt(t, e, i, s) {
  ...
  const n = D([t[4], t[5], t[6]]),
    l = D([t[8], t[9], t[10]]);
  (we(t) < 0 && (r = -r), (i[0] = t[12]), (i[1] = t[13]), (i[2] = t[14]));
  const c = t.slice(),
    h = 1 / r,
    d = 1 / n,
    f = 1 / l;
...
function Dt(t, e, i, s) {
  let r = e[0],
    ...
    p = l - i[2],
    g = d * d + f * f + p * p;
  g === 0 ? (p = 1) : ((g = 1 / Math.sqrt(g)), (d *= g), (f *= g), (p *= g));
  let x = c * p - h * f,
    m = h * d - o * p,
    u = o * f - c * d;
  return (
...
class W extends Array {
  constructor(
    ...
    return (super(e, i, s, r, n, l, o, c, h, d, f, p, g, x, m, u), this);
  }
  get x() {
    return this[12];
  }
  ...
  set(e, i, s, r, n, l, o, c, h, d, f, p, g, x, m, u) {
    return e.length
      ? this.copy(e)
      : (Et(this, e, i, s, r, n, l, o, c, h, d, f, p, g, x, m, u), this);
  }
  translate(e, i = this) {
    return (Tt(this, i, e), this);
  }
  rotate(e, i, s = this) {
    return (Ft(this, s, e, i), this);
  }
  scale(e, i = this) {
    return (At(this, i, typeof e == "number" ? [e, e, e] : e), this);
  }
  add(e, i) {
    return (i ? oe(this, e, i) : oe(this, this, e), this);
  }
  sub(e, i) {
    return (i ? ce(this, e, i) : ce(this, this, e), this);
  }
  multiply(e, i) {
    return (
      e.length ? (i ? ae(this, e, i) : ae(this, this, e)) : Wt(this, this, e),
      this
    );
  }
  identity() {
  ...
  copy(e) {
    return (Ct(this, e), this);
  }
  fromPerspective({ fov: e, aspect: i, near: s, far: r } = {}) {
    return (Ot(this, e, i, s, r), this);
  }
  fromOrthogonal({ left: e, right: i, bottom: s, top: r, near: n, far: l }) {
    return (Nt(this, e, i, s, r, n, l), this);
  }
  fromQuaternion(e) {
  ...
  compose(e, i, s) {
    return (Lt(this, e, i, s), this);
  }
  decompose(e, i, s) {
    return (Rt(this, e, i, s), this);
  }
  getRotation(e) {
    return (Ce(e, this), this);
  }
  getTranslation(e) {
    return (kt(e, this), this);
  }
  getScaling(e) {
    return (ze(e, this), this);
  }
  getMaxScaleOnAxis() {
    return It(this);
  }
  lookAt(e, i, s) {
    return (Dt(this, e, i, s), this);
  }
  determinant() {
    return we(this);
  }
...
class Vt extends Array {
  ...
  fromRotationMatrix(e, i = this.order) {
    return ($t(this._target, e, i), this.onChange(), this);
  }
  fromQuaternion(e, i = this.order, s) {
    return (
      he.fromQuaternion(e),
      this._target.fromRotationMatrix(he, i),
      s || this.onChange(),
      this
    );
  }
...
class Pt {
  constructor() {
    ((this.parent = null),
      ...
      (this.position = new R()),
      (this.quaternion = new wt()),
      (this.scale = new R(1)),
      (this.rotation = new Vt()),
      (this.up = new R(0, 1, 0)),
...
function Xt(t, e, i, s, r, n, l, o, c, h) {
  return (
    (t[0] = e),
    (t[1] = i),
    (t[2] = s),
...
class ei extends Array {
  constructor(e = 1, i = 0, s = 0, r = 0, n = 1, l = 0, o = 0, c = 0, h = 1) {
    return (super(e, i, s, r, n, l, o, c, h), this);
  }
  set(e, i, s, r, n, l, o, c, h) {
    return e.length
      ? this.copy(e)
      : (Xt(this, e, i, s, r, n, l, o, c, h), this);
  }
  translate(e, i = this) {
    return (Zt(this, i, e), this);
  }
  rotate(e, i = this) {
    return (Qt(this, i, e), this);
  }
  scale(e, i = this) {
    return (Kt(this, i, e), this);
  }
  multiply(e, i) {
    return (i ? de(this, e, i) : de(this, this, e), this);
  }
  identity() {
    return (Ht(this), this);
  }
  ...
  fromBasis(e, i, s) {
    return (
      this.set(e[0], e[1], e[2], i[0], i[1], i[2], s[0], s[1], s[2]),
      this
    );
  }
  inverse(e = this) {
    return (Yt(this, e), this);
  }
  getNormalMatrix(e) {
...
class xe extends Array {
  constructor(e) {
    return Array.isArray(e) ? super(...e) : super(...ge(...arguments));
  }
  get r() {
    return this[0];
  }
  ...
  set(e) {
    return Array.isArray(e) ? this.copy(e) : this.copy(ge(...arguments));
  }
  copy(e) {
...
function ai({
  ...
  const n = z.useRef({ colorStops: t, amplitude: e, blend: i, speed: s });
  n.current = { colorStops: t, amplitude: e, blend: i, speed: s };
  const l = z.useRef(null);
  return (
    z.useEffect(() => {
      const o = l.current;
      if (!o) return;
      const c = new rt({ alpha: !0, premultipliedAlpha: !0, antialias: !0 }),
        h = c.gl;
      (h.clearColor(0, 0, 0, 0),
        h.enable(h.BLEND),
        h.blendFunc(h.ONE, h.ONE_MINUS_SRC_ALPHA),
        (h.canvas.style.backgroundColor = "transparent"));
      let d;
      const f = () => {
        const u = o.offsetWidth,
          b = o.offsetHeight;
        (c.setSize(u, b), d && (d.uniforms.uResolution.value = [u, b]));
      };
      ...
      const g = new ii(h, { geometry: p, program: d });
      o.appendChild(h.canvas);
      let x = 0;
      const m = (u) => {
        x = requestAnimationFrame(m);
        const b = n.current;
        d &&
          ((d.uniforms.uTime.value = u * 0.001 * (b.speed ?? 1)),
          (d.uniforms.uAmplitude.value = b.amplitude ?? 1.2),
          (d.uniforms.uBlend.value = b.blend ?? 0.6),
          (d.uniforms.uColorStops.value = (b.colorStops ?? t).map((C) => {
            const S = new xe(C);
            return [S.r, S.g, S.b];
          })),
          c.render({ scene: g }));
      ...
      return (
        ...
        () => {
          (cancelAnimationFrame(x),
            ...
            o && h.canvas.parentNode === o && o.removeChild(h.canvas),
...
const oi = ({
  children: t,
  className: e = "",
  spotlightColor: i = "rgba(255, 255, 255, 0.12)",
  onClick: s,
  style: r,
}) => {
  const n = z.useRef(null),
    l = (o) => {
      ...
      const c = n.current.getBoundingClientRect(),
        h = o.clientX - c.left,
        d = o.clientY - c.top;
      (n.current.style.setProperty("--mouse-x", `${h}px`),
        n.current.style.setProperty("--mouse-y", `${d}px`),
        n.current.style.setProperty("--spotlight-color", i));
    };
  return a.jsx("div", {
    ref: n,
    onMouseMove: l,
...
function _({
  ...
  (Ie((y) => {
    ...
    const v = y - p.current;
    if (((p.current = y), (f.current += v), o)) {
      const j = g * 2,
        E = f.current % j;
      d.set(E < g ? (E / g) * 100 : 100 - ((E - g) / g) * 100);
    } else d.set((f.current / g) * 100);
  }),
    z.useEffect(() => {
      ((f.current = 0), d.set(0));
    }, [s, d, o]));
  const x = ke(d, (y) => (n === "vertical" ? `50% ${y}%` : `${y}% 50%`)),
    m = z.useCallback(() => {
      l && h(!0);
    }, [l]),
    u = z.useCallback(() => {
    ...
    C = [...i, i[0]].join(", "),
    S = {
      backgroundImage: `linear-gradient(${b}, ${C})`,
      backgroundSize:
        n === "horizontal"
          ? "300% 100%"
          : n === "vertical"
  ...
  return a.jsxs(V.div, {
    className: `animated-gradient-text ${r ? "with-border" : ""} ${e}`,
    onMouseEnter: m,
    onMouseLeave: u,
    children: [
      r &&
...
const B = 900,
  ...
  pi = "@mad__dentist",
  gi = "https://www.tiktok.com/@mad__dentist";
function xi(t, e) {
  const i = (e - t * B) / B;
  if (i < -0.35 || i >= 1)
  ...
  return (
    i < 0
      ? ((s = (i + 0.35) / 0.35), (r = 50 * (1 - s)))
      : i < 0.65
        ? ((s = 1), (r = -i * 24))
        : ((s = 1 - (i - 0.65) / 0.35), (r = -i * 24)),
    {
...
function ui({ scrollY: t }) {
  const e = { fontFamily: "'Syne', sans-serif" },
  ...
  return a.jsxs("div", {
    ...
    children: [
      a.jsx("div", { style: L(t, 0, -0.06, "8%", "15%", 180, "#c8ff00") }),
      a.jsx("div", { style: L(t, 0, 0.08, "78%", "10%", 120, "#00e5ff") }),
      a.jsx("div", { style: L(t, 0, -0.04, "85%", "65%", 260, "#ff3d8b") }),
      a.jsx("div", { style: L(t, 0, 0.05, "2%", "70%", 90, "#a855f7") }),
      a.jsx("div", {
        children: a.jsxs("div", {
          style: {
      ...
      a.jsx("div", {
        style: { display: "flex", gap: 48, marginTop: 8 },
        children: [
  ...
  return a.jsxs("div", {
    ...
    children: [
      a.jsxs("div", {
        children: [
          a.jsx("div", {
            style: L(t, 1, -0.05, "-10%", "20%", 160, "#00e5ff"),
          }),
          a.jsxs("div", {
            style: {
      ...
      a.jsx("div", {
        ...
        children: ue.map((o, c) =>
          a.jsxs(
            oi,
            {
              spotlightColor: `${o.color}28`,
              onClick: () => r(s === c ? null : c),
              style: {
                padding: "18px 20px",
                cursor: "pointer",
                transition: "border-color 0.2s, box-shadow 0.2s",
                borderColor: s === c ? o.color : "rgba(255,255,255,0.07)",
                boxShadow: s === c ? `0 0 18px ${o.color}30` : "none",
              },
              children: [
                a.jsx("div", {
                  style: {
                ...
                a.jsxs("div", {
                  ...
                  children: [
                    ...
                    a.jsx("div", {
                      style: {
                        fontSize: 9,
                        color: s === c ? o.color : "rgba(255,255,255,0.2)",
                        transition: "color 0.2s",
                        ...i,
                      },
                      children: s === c ? "▲ згорнути" : "▼ ціни",
                    }),
                  ],
                }),
              ],
          ...
          children: [
            ...
            a.jsxs("div", {
              ...
              children: [
                ...
                a.jsx("div", {
                  style: {
                    borderTop: `1px solid ${n.color}25`,
                    paddingTop: 16,
                    display: "flex",
                    flexDirection: "column",
                    gap: 10,
                  },
                  children: l.items.map((o, c) =>
                    a.jsxs(
                      "div",
                      {
                        style: {
                        ...
                        children: [
                          a.jsx("span", {
                            style: { color: "rgba(255,255,255,0.75)", ...i },
                            children: o.name,
                          }),
                          a.jsx("span", {
                            style: {
                              flex: 1,
                              borderBottom: `1px dotted ${n.color}30`,
                              marginBottom: 3,
                            },
                          }),
                          a.jsx("span", {
...
function yi({ c: t }) {
  const [e, i] = z.useState(50),
    s = z.useRef(null),
    r = z.useRef(!1),
    n = z.useCallback((l) => {
      if (!s.current) return;
      const o = s.current.getBoundingClientRect();
      i(Math.max(0, Math.min(100, ((l - o.left) / o.width) * 100)));
    }, []);
  return (
    z.useEffect(() => {
      const l = (c) => {
          r.current && n("touches" in c ? c.touches[0].clientX : c.clientX);
        },
        o = () => {
          r.current = !1;
        };
    ...
    a.jsxs("div", {
      ...
      children: [
        a.jsxs("div", {
          ref: s,
          onMouseDown: (l) => {
            ((r.current = !0), n(l.clientX));
          },
          onTouchStart: (l) => {
            ((r.current = !0), n(l.touches[0].clientX));
          },
          style: {
            position: "relative",
            width: "100%",
...
function bi({ scrollY: t }) {
  ...
  return a.jsxs("div", {
    ...
    children: [
      a.jsxs("div", {
        children: [
          a.jsx("div", { style: L(t, 2, 0.06, "-5%", "60%", 200, "#ff3d8b") }),
          a.jsxs("div", {
            style: {
          ...
          a.jsxs("div", {
            ...
            children: [me.length, " кейси · перетягни повзунок"],
          }),
        ],
      }),
      a.jsx("div", {
        style: { display: "flex", gap: 14, alignItems: "stretch" },
        children: me.map((s, r) => a.jsx(yi, { c: s }, r)),
      }),
    ],
  });
}
function vi({ scrollY: t }) {
  const e = { fontFamily: "'Syne', sans-serif" },
    i = { fontFamily: "'Space Grotesk', sans-serif" };
  return a.jsxs("div", {
    style: {
    ...
    children: [
      a.jsxs("div", {
        ...
        children: [
          a.jsx("div", { style: L(t, 3, -0.07, "70%", "5%", 300, "#a855f7") }),
          a.jsx("div", {
            style: {
              fontSize: 9,
              ...
              children: [
                a.jsxs("div", {
                  style: {
                    ...
                    width: "100%",
                    aspectRatio: "16/9",
                    background: `linear-gradient(135deg,${s.accent}18,#100c18)`,
                    borderRadius: 3,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
...
function Si({ scrollY: t }) {
  const e = { fontFamily: "'Syne', sans-serif" },
    i = { fontFamily: "'Space Grotesk', sans-serif" };
  return a.jsxs("div", {
    style: { width: "100%", maxWidth: 1e3 },
    children: [
      a.jsx("div", { style: L(t, 4, 0.05, "90%", "15%", 140, "#c8ff00") }),
      a.jsxs("div", {
...
function wi({ scrollY: t }) {
  const [e, i] = z.useState(0),
    s = { fontFamily: "'Syne', sans-serif" },
    r = { fontFamily: "'Space Grotesk', sans-serif" },
    n = a.jsx("svg", {
      width: "14",
      height: "14",
      viewBox: "0 0 24 24",
  ...
  return a.jsxs("div", {
    ...
    children: [
      a.jsx("div", {
        ...
        children: [
          { label: "TikTok", icon: n, color: "#ff3d8b" },
          { label: "Instagram", icon: l, color: "#e1306c" },
        ].map((o, c) =>
          a.jsxs(
            "button",
            {
              ...
              style: {
                ...
                letterSpacing: "0.14em",
                textTransform: "uppercase",
                background: e === c ? o.color : "rgba(255,255,255,0.06)",
                color: e === c ? "#0a0a0a" : "rgba(255,255,255,0.4)",
                transition: "all 0.2s",
              },
            ...
            a.jsxs("div", {
              ...
              children: [
                a.jsxs("div", {
                  children: [
                    a.jsx("div", {
                      style: L(t, 5, -0.05, "-8%", "20%", 160, "#ff3d8b"),
                    }),
                    a.jsx("div", {
                      style: L(t, 5, 0.07, "95%", "70%", 100, "#00e5ff"),
                    }),
                    a.jsxs("div", {
                      style: {
                        marginBottom: 16,
                        ...
                        children: [
                          a.jsx("div", {
                            ...
                            children: a.jsx("iframe", {
                              src: `https://www.tiktok.com/embed/v2/${o.id}`,
                              title: o.caption,
                              allow:
                      ...
                      "div",
                      {
                        ...
                        children: [
                          a.jsx("div", {
                            ...
                            children: a.jsx("iframe", {
                              src: `https://www.instagram.com/reel/${o.id}/embed/`,
                              style: {
                                width: "100%",
                                height: "100%",
                                border: "none",
...
function Ei({ scrollY: t }) {
  const e = { fontFamily: "'Syne', sans-serif" },
    ...
    [n, l] = z.useState("idle"),
    o = (f) => (p) => r((g) => ({ ...g, [f]: p.target.value })),
    c = async (f) => {
      if ((f.preventDefault(), !(!s.name.trim() || !s.phone.trim()))) {
        l("loading");
        try {
          (Y
            ? await Y.from("contact_requests").insert({
                name: s.name.trim(),
                phone: s.phone.trim(),
                service: s.service || null,
                contact_via: s.contact_via || null,
                ...
                children: [
                  a.jsxs("div", {
                    ...
                    children: [
                      a.jsxs("div", {
                        children: [
                          a.jsx("label", { style: d, children: "Ваше ім'я" }),
                          a.jsx("input", {
                            required: !0,
                            type: "text",
                      ...
                      a.jsxs("div", {
                        children: [
                          a.jsx("label", { style: d, children: "Телефон *" }),
                          a.jsx("input", {
                            required: !0,
                            type: "tel",
                  ...
                  a.jsxs("div", {
                    ...
                    children: [
                      a.jsxs("div", {
                        children: [
                          a.jsx("label", { style: d, children: "Послуга" }),
                          a.jsxs("select", {
                            value: s.service,
                            onChange: o("service"),
                            style: {
                  ...
                  a.jsx("button", {
                    ...
                    style: {
                      ...
                      border: "none",
                      borderRadius: 2,
                      cursor: n === "loading" ? "wait" : "pointer",
                      opacity: n === "loading" ? 0.7 : 1,
                      transition: "opacity 0.2s",
                      fontFamily: "'Syne',sans-serif",
                    },
                    children:
                      n === "loading" ? "Надсилається..." : "Надіслати запит →",
                  }),
                  n === "err" &&
                    a.jsx("p", {
                      style: {
...
function Ri() {
  ...
  (z.useEffect(() => {
    ...
    z.useEffect(() => {
      localStorage.getItem("designMode") === "zoomer" && h();
      const y = () => h();
      return (
        window.addEventListener("zoomer:open", y),
        () => window.removeEventListener("zoomer:open", y)
      );
    }, [h]),
    z.useEffect(
      () => (
  ...
  const f = z.useCallback(() => {
    ...
    if (!y) return;
    const v = y.scrollTop;
    (o(v), n(Math.min(Math.floor(v / B), O.length - 1)));
  }, []);
  z.useEffect(() => {
    if (!t) return;
    const y = c.current;
  ...
  const p = (y) => {
      c.current?.scrollTo({ top: y * B + 20, behavior: "smooth" });
    },
    g = { fontFamily: "'Syne', sans-serif" },
    x = { fontFamily: "'Space Grotesk', sans-serif" },
    m = a.jsx("button", {
      onClick: h,
      style: {
        position: "fixed",
      ...
      onMouseEnter: (y) => {
        ...
        ((v.style.background = "#c8ff00"), (v.style.color = "#0a0a0a"));
      },
      onMouseLeave: (y) => {
        const v = y.currentTarget;
        ((v.style.background = "#0a0a0a"), (v.style.color = "#c8ff00"));
      },
      children: "◆ Modern Mode",
    });
  if (!t) return m;
  const u = Math.min(l / (B * O.length), 1),
    b = [
      ...
      a.jsx("div", {
        ...
        children: a.jsxs("div", {
          ...
          children: [
              ...
              children: [
                ...
                a.jsx("div", {
                  style: {
                    ...
                    transform: `translateY(${l * 0.04}px)`,
                  },
                }),
                a.jsx("div", {
                  style: {
                ...
                a.jsxs("div", {
                  ...
                  children: [
                    ...
                    a.jsx("button", {
                      ...
                      onMouseEnter: (y) => {
                        const v = y.currentTarget;
                        ((v.style.borderColor = "#c8ff00"),
                          (v.style.color = "#c8ff00"));
                      },
                      onMouseLeave: (y) => {
                        const v = y.currentTarget;
                        ((v.style.borderColor = "rgba(255,255,255,0.18)"),
                          (v.style.color = "rgba(255,255,255,0.5)"));
                      },
                      children: "← Classic",
                    }),
                  ],
                    ...
                    a.jsx(
                      "button",
                      {
                        ...
                        style: {
                          ...
                          borderRadius: "50%",
                          background:
                            v === r ? y.accent : "rgba(255,255,255,0.18)",
                          border: "none",
                          cursor: "pointer",
                          padding: 0,
                          transition: "all 0.3s",
            ...
            a.jsx("div", { style: { height: B * O.length } }),
          ],
        }),
      }),
    ],
